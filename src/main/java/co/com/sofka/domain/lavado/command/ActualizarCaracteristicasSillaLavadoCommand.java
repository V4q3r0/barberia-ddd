...
public class ActualizarCaracteristicasSillaLavadoCommand extends Command {
    private final LavadoId lavadoId;
    private final NombreC nombreC;
    private final Precio precio;

    public ActualizarCaracteristicasSillaLavadoCommand(LavadoId lavadoId, NombreC nombreC, Precio precio){
